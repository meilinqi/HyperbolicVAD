...
def parse_args():
    ...
    parser.add_argument('--lr', default = 0.0005, help = 'learning rates for steps(list form)')
    parser.add_argument('--momentum', default=0.999, help='momentum in optimizer)')
    # parser.add_argument('--lr', type=str, default='[0.0005]*3000', help='learning rates for steps(list form)')
    parser.add_argument('--batch_size', type = int, default = 64)
    parser.add_argument('--num_workers', type = int, default = 0)
    parser.add_argument('--num_segments', type = int, default = 150)
    ...
    parser.add_argument('--optimizer', type=str, default='radam',help='which optimizer to use, can be any of [rsgd, radam]')
    parser.add_argument('--lr-reduce-freq', type=str, default='300',
                        help='reduce lr every lr-reduce-freq or None to keep lr constant')

    parser.add_argument('--weight-decay', default=0., help='l2 regularization strength')
    parser.add_argument('--dropout', default=0.6, help='x x')
    parser.add_argument('--gamma', default=0.5, help='gamma for lr scheduler')
    ...
    parser.add_argument('--c', default=0.04, help='hyperbolic radius, set to None for trainable curvature')
    ...
    parser.add_argument('--lamda', type=float, default=0.5, help='input size of feature for HGCN (default: 2048)')

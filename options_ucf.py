...
def parse_args():
    ...
    parser.add_argument('--lr', default = 0.1, help = 'learning rates for steps(list form)')
    ...
    parser.add_argument('--optimizer', type=str, default='rsgd',help='which optimizer to use, can be any of [rsgd, radam]')
    ...
    parser.add_argument('--c', default=0.3, help='hyperbolic radius, set to None for trainable curvature')
    ...
    parser.add_argument('--lamda', type=float, default=0., help='input size of feature for HGCN (default: 2048)')
